...
from network.models import VICReg
from utils.generators import pretrain_data_generator
from utils.loader import load_pretrain_data
...
def pretrain_model(
    *,
    ...
    for epoch in range(epochs):
        ...
        broken_epoch = False
        for _ in tqdm.tqdm(
            range(train_steps), position=0, leave=True, disable=not is_interactive
        ):
